...
- Python, Flask, FastAPI, automações e scraping
- JavaScript, TypeScript, React, Next.js e dashboards
- SQLite, Supabase/PostgreSQL e modelagem de dados
- IA aplicada com Gemini, LLMs locais, RAG, agentes e workflows
- Testes automatizados, CI, segurança básica e deploy
- Civic tech, dados públicos, análise eleitoral e monitoramento de contratos
...
Plataforma fullstack de saúde pessoal com dashboard, nutrição, treinos, dados de wearable, Supabase Auth, API interna e IA Coach.
...
Assistente pessoal de IA com múltiplos agentes, roteamento de modelos, memória persistente, RAG, integração com Telegram, MCP server e automações.

**Stack:** Python, Flask, SQLite, Supabase, Gemini, Groq, Ollama, Telegram Bot, pytest  
**Repositório:** https://github.com/simoesleandro/hermes-lite
